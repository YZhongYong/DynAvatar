...
def plot_images(model_outputs, ground_truth, path, epoch, img_index, plot_nrow, img_res, batch_size, is_eval):
    ...
    normal_points = model_outputs['rend_normal']
    normal_points = normal_points.reshape(batch_size, num_samples, 3)
    
    normalc_points = model_outputs['surf_normal']
    ...
    output_vs_gt = torch.cat((output_vs_gt, model_outputs['rend_normal'].reshape(batch_size, num_samples, 3)), dim=0)
    output_vs_gt = torch.cat((output_vs_gt, normalc_points), dim=0)
